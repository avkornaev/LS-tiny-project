...
1. Read `README.md` completely and inspect the repository.
...
- Use SGD with learning rate 0.1, batch size 128, and 10 epochs.
...
- Support CPU execution; GPU acceleration may be optional.
